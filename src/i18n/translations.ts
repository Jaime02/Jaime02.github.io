...
export const translations = {
  en: {
    ...
    index: {
      ...
      title3: " experts",
      definition: "Screw machining refers to the manufacturing of parts of revolution (screws, shafts, bolts...) by machining bar or roll material by chip removal using a cutting tool for series production.",
    ...
    location: {
      ...
      description: "We are located in Peralta, locality that is located in the south of the Community of Navarra. Limited to the north with Falces, to the east with Marcilla, to the south with Funes and to the west with Azagra, San Adrián and Andosilla."
    },
    contact: {
      title: "Contact"
    }
...
export function useTranslations(lang: Lang) {
  return function t<T extends PageKeys>(
    pageKey: T,
    key: KeyOfPage<T>
  ): string {
